    ...
    {
        {
            ...
            String mnu[] =
            {
                ".- Define profesores", ".- Define instituciones", ".- Define materias", ".- Define alumnos", ".- Carga profesores ", ".- Carga instituciones ", ".- Carga Materia", ".- Carga alumno", ".- Carga muestra", ".- Mueve alumno ", ".- Elimina alumno", ".- Elimina alumnos", ".- Salir..."
            };
            do
            {
                x = obj.pintaMenu(mnu);
